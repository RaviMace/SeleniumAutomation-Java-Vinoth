...
public class HandlingMultiTabs {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement newBrowserTab = driver.findElement(By.name("newbrowsertab453"));
		newBrowserTab.click();
		...
		System.out.println("Parent window id is "+parentWindowTab);
		String childWindowTab = iterator.next();
		System.out.println("Child window id is "+childWindowTab);
